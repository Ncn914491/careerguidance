    ...
    return (
      <div className="space-y-6">
        <div className="space-y-2">
          <div className="h-8 bg-glass animate-pulse rounded w-1/3 mb-2"></div>
          <div className="h-4 bg-glass animate-pulse rounded w-2/3 mb-6"></div>
        </div>
        <div className="space-y-6">
          {/* Loading skeleton for My Groups */}
          <div className="space-y-4">
            <div className="h-6 bg-glass animate-pulse rounded w-1/4"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2].map(i => (
                <div key={i} className="bg-glass backdrop-blur-md rounded-xl border border-glass p-6">
                  <div className="animate-pulse">
                    <div className="h-6 bg-glass-light rounded w-3/4 mb-3"></div>
                    <div className="h-4 bg-glass-light rounded w-full mb-2"></div>
                    <div className="h-4 bg-glass-light rounded w-1/2 mb-4"></div>
                    <div className="flex gap-2">
                      <div className="h-10 bg-glass-light rounded flex-1"></div>
                      <div className="h-10 bg-glass-light rounded w-20"></div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {/* Loading skeleton for Available Groups */}
          <div className="space-y-4">
            <div className="h-6 bg-glass animate-pulse rounded w-1/4"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="bg-glass backdrop-blur-md rounded-xl border border-glass p-6">
                  <div className="animate-pulse">
                    <div className="h-6 bg-glass-light rounded w-3/4 mb-3"></div>
                    <div className="h-4 bg-glass-light rounded w-full mb-2"></div>
                    <div className="h-4 bg-glass-light rounded w-2/3 mb-4"></div>
                    <div className="h-10 bg-glass-light rounded w-full"></div>
                  </div>
                </div>
              ))}
            </div>
